...
def place_pending_orders():
    ...
    # Use Manual Account Size for Prop Firm Risk Management
    account_size = config.MANUAL_ACCOUNT_SIZE
    
    buy_lot = calculate_position_size(buy_entry, buy_sl, account_size)
    sell_lot = calculate_position_size(sell_entry, sell_sl, account_size)
