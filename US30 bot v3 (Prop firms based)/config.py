...
RISK_PERCENT = 33.33     # Percentage of MANUAL_ACCOUNT_SIZE to risk per trade
MANUAL_ACCOUNT_SIZE = 100000.0 # [NEW] Manual account size for Prop Firm risk calculation
