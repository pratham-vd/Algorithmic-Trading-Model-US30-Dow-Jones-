...
def place_pending_orders():
    ...
    # balance = account_info.balance <-- No longer needed independently
    
    # Pass the full account_info object for margin check
    buy_lot = calculate_position_size(buy_entry, buy_sl, account_info)
    sell_lot = calculate_position_size(sell_entry, sell_sl, account_info)
